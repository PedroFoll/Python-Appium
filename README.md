...
```
cd existing_repo
git remote add origin https://gitlab.com/ulisses1991/automation704_flask.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ulisses1991/automation704_flask/-/settings/integrations)
